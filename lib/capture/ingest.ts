...
export async function ingestText(
  ...
  // A stated duration ("30 min", "2-2:30pm") gives the calendar block its length
  // (FR28); undated/duration-less captures fall back to the default at render.
  const effortMin = extractDurationMin(text);
